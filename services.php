...
<head>
  ...
  <!-- Site Title -->
  <title>Acture Media | Our Services </title>
            ...
            <div class="row">
              <div class="col">
                <div class="section_heading d-flex flex-xl-nowrap flex-wrap justify-content-between container-space">
                  ...
                  <div class="sec_right">
                    <h1 class="sec_title fs-230 tj-reveal-line">BRAND FOUNDATION STUDIO</h1>
                    <h2 class="about_text uppercase tj-reveal-line"><span class="space">Design How You're Seen. Define Why You're Chosen.</span>
                      </h2>
                  </div>
                </div>
              </div>
              ...
              <div class="col">
                <div class="h7-service-header d-flex flex-wrap align-items-end justify-content-between gap-3">
                  <div class="section_heading">
                    ...
                    <h2 class="sec_title tj-reveal-line">You Built A Good Business. Your Brand Should Show It.</h2>
                  </div>
                  ...
                  <div class="col-lg-4">
                    <div class="h7-service-item tj-fade" data-delay="0.1">
                      ...
                      <div class="h7-service-content">
                        <h3 class="service-title tj-fz-h4"><a href="service-details.php">Brand Positioning</a></h3>
                        <p class="service-desc">We define what your business stands for, where it fits in the market and why it should be chosen over your competitors. We conduct primary and secondary research to build a statement that actually works, not one that just sounds right. Validation in this stage is key to ensuring we crack the right sweet spot.</p>
                      </div>
                    </div>
                  </div>
                  <div class="col-lg-4">
                    <div class="h7-service-item tj-fade" data-delay="0.3">
                      ...
                      <div class="h7-service-content">
                        <h3 class="service-title tj-fz-h4"><a href="service-details.php">Brand Architecture</a></h3>
                        <p class="service-desc">We organize your brand structure to support clarity, scale and stronger communication. We help design a visual and verbal architecture model, whether house of brands, branded house or hybrid, that shows how your products, services or sub-brands relate and communicate.</p>
                      </div>
                    </div>
                  </div>
                  <div class="col-lg-4">
                    <div class="h7-service-item tj-fade" data-delay="0.5">
                      ...
                      <div class="h7-service-content">
                        <h3 class="service-title tj-fz-h4"><a href="service-details.php">Customer Psychology Mapping</a></h3>
                        <p class="service-desc">We understand what your audience notices, trusts, compares and responds to before they convert. This one is primarily different because a psychology-led audience profile covering decision triggers, trust signals, objections and the emotional and rational hierarchy that drives purchase is one of the most important markers for potential success.</p>
                      </div>
                    </div>
                  </div>
                  <div class="col-lg-6">
                    <div class="h7-service-item tj-fade" data-delay="0.7">
                      ...
                      <div class="h7-service-content">
                        <h3 class="service-title tj-fz-h4"><a href="service-details.php">Brand Identity</a></h3>
                        <p class="service-desc">We build a distinctive identity system that makes the brand easier to recognize and harder to confuse. Right from a cohesive logo system, that experiments across platforms and tells a story that sits within the framework of your positioning narrative and brand architecture.</p>
                      </div>
                    </div>
                  </div>
                  <div class="col-lg-6">
                    <div class="h7-service-item tj-fade" data-delay="0.9">
                      ...
                      <div class="h7-service-content">
                        <h3 class="service-title tj-fz-h4"><a href="service-details.php">Brand Guidelines</a></h3>
                        <p class="service-desc">We set the standards that keep your brand consistent across teams, platforms and growth stages with a comprehensive brand guideline docket covering usage rules, tone of voice, visual do's and don'ts, and application examples built for real teams to actually use with every editable element present.</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="col">
                <div class="h1_process_wrapper">
                  <div class="section_heading d-block d-xl-none">
                    <span class="sec_subtitle tj-fade">[ <span>WHO WE WORK WITH</span> ]</span>
                    <div class="section_heading_inner">
                      <h2 class="sec_title tj-reveal-line">THE BUSINESSES WE BUILD FOR</h2>
                    </div>
                  </div>
                  <div class="h1_process_wrap">
                    <div class="process_section_left d-none d-xl-flex">
                      ...
                      <div class="h1_process_no tj-fade">
                        <span>Startups preparing to launch</span>
                        <span>Founders who've outgrown their first brand</span>
                        <span>Companies entering a new market</span>
                        <span>Businesses that look like their competitors</span>
                        <span>Teams preparing for a fundraiser or acquisition</span>
                      </div>
                    </div>
                    <div class="h1_process_images tj-fade">
                      <div class="tj_process_img panel">
                        <img src="images/services/1_brand foundation/1.jpg.jpeg" alt="">
                      </div>
                      <div class="tj_process_img panel x-100">
                        <img src="images/services/1_brand foundation/2.jpg.jpeg" alt="">
                      </div>
                      <div class="tj_process_img panel x-100">
                        <img src="images/services/1_brand foundation/3.jpg.jpeg" alt="">
                      </div>
                      <div class="tj_process_img panel x-100">
                        <img src="images/services/1_brand foundation/4.jpg.jpeg" alt="">
                      </div>
                      <div class="tj_process_img panel x-100">
                        <img src="images/services/1_brand foundation/5.jpg.jpeg" alt="">
                      </div>
                    </div>
                    ...
                    <div class="h1_process_items tj-fade">
                      <div class="tj_process_item_2">
                        <div class="process_top">
                          ...
                          <div class="process_desc">You're building from zero and want to do it right the first time
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="tj_process_item_2">
                        <div class="process_top">
                          ...
                          <div class="process_desc">Your business has evolved, but your brand hasn't caught up
                          </div>
                        </div>
                      ...
                      <div class="tj_process_item_2">
                        <div class="process_top">
                          <div class="process_wrap d-lg-none">
                            <div class="process_no">
                              Businesses that look like their competitors
                            </div>
                          ...
                          <div class="process_desc">You need to show up with credibility in a space that doesn't know you yet</div>
                        </div>
                      ...
                      <div class="tj_process_item_2">
                        <div class="process_top">
                          ...
                          <div class="process_desc">You're good at what you do, but nothing about your brand shows it.</div>
                        </div>
                      ...
                      <div class="tj_process_item_2">
                        <div class="process_top">
                          <div class="process_wrap d-lg-none">
                            <div class="process_no">
                              Teams preparing for a fundraiser or acquisition
                            </div>
                          ...
                          <div class="process_desc">First impressions at the boardroom level are built long before the meeting</div>
                        </div>
                    ...
                    <div class="swiper-wrapper">
                      ...
                      <div class="swiper-slide">
                        <div class="tj_testimonial_item about_testimonial_item">
                          ...
                          <div class="testimonial_content">
                            <div class="review_text">
                              <span>"We partnered with [Agency Name] for a full brand overhaul, and the results
